var Carousel=function(a){this.element=a;this.init()};
Carousel.prototype.init=function(){var a=this;this.carouselContent=this.element.querySelector(".carousel-content");this.items=this.carouselContent.querySelectorAll(".carousel-item");this.element.querySelector(".carousel-nav-left").addEventListener("click",function(b){a.prevSlide();a.autoplayInterval&&(clearInterval(a.autoplayInterval),a.autoPlay(a.element.dataset.delay||5E3))},!1);this.element.querySelector(".carousel-nav-right").addEventListener("click",function(b){a.nextSlide();a.autoplayInterval&&
