...
var bulmaCalendar = function (_EventEmitter) {
  ...
  _createClass(bulmaCalendar, [{
    ...
    value: function _renderDays() {
      ...
      // will try to use weekStart from options if provided, also verify if it's in the range 0 ~ 6
      // TODO: get moment week start
      console.log(__WEBPACK_IMPORTED_MODULE_1_moment___default()().startOf('week').day());
      console.log(__WEBPACK_IMPORTED_MODULE_1_moment___default()().weekday(1).day());
      var startDay = typeof this.options.weekStart != 'number' && this.options.weekStart >= 0 && this.options.weekStart <= 6 ? this.options.weekStart : 1;
      if (startDay > 0) {
        before -= startDay;
        if (before < 0) {
          before += 7;
